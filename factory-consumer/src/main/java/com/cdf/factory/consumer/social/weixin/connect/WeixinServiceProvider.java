package com.cdf.factory.consumer.social.weixin.connect;

import org.springframework.social.oauth2.AbstractOAuth2ServiceProvider;

import com.cdf.factory.consumer.social.weixin.api.Weixin;
import com.cdf.factory.consumer.social.weixin.api.impl.WeiXinImpl;

/**
 * 微信的OAuth2流程处理器的提供器，供spring social的connect体系调用 Created on 2018/1/11.
 *
 * @author zlf
 * @since 1.0
 */
