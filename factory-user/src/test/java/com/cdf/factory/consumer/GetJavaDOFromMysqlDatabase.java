...
public class GetJavaDOFromMysqlDatabase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filePath = projectPath
                + "factory-"+serviceName+"\\src\\main\\java\\com\\cdf\\factory\\" + serviceName + "\\entity";
        String fileMapperPath = projectPath +  "factory-"+serviceName + "\\src\\main\\java\\com\\cdf\\factory\\" + serviceName + "\\mapper";
        ...
        try {
            ...
            tableMap.forEach((key, value) -> {
                try {
                    ...
                    createDOFile(value, filePath, ".java", columnList);
