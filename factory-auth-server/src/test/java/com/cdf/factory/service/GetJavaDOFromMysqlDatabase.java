...
public class GetJavaDOFromMysqlDatabase {
    ...
    public static void main(String[] args) throws Exception {
        String serviceName = "risk";
        String projectPath = "D:\\git\\saas-southeast-fintech\\";
        String filePath = projectPath + serviceName
                + "\\src\\main\\java\\com\\rocky\\fintech\\" + serviceName + "\\entity";
        ...
        tableMap.put("risk_rule", "RiskRuleDO");
